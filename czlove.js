/*
小程序：纯甄粉爱俱乐部
抓域名ucode-openapi.aax6.cn
查看请求头Authorization: XXXXXXXXXXXX
变量
...
[task_local]
0 0 * * * http://nm6.xyz:20080/ningmeng/ningmeng/raw/branch/main/czlove.js, tag=纯甄粉爱俱乐部, enabled=true
*/
...
body:`{"promotionId":1001681,"promotionCode":"CRM-QD"}`
};
    if (debug) {
            log(`\n【debug】=============== 这是  请求 url ===============`);
            log(JSON.stringify(options));
