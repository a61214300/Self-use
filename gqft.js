 ...
 * 23/10/13 抓登录时 https://gw.nevapp.gtmc.com.cn/main/api/community/lgn/user/getLoginUserInfo请求头的 Authorization 去掉Bearer，多账号用@隔开
 * ===== 青龙--配置文件 =====
...
if (isRun) {
    ...
    let userIdx = 0;
    let userCount = 0;    
    let scriptVersionNow = "0.0.7"; //现在版本
    window = {};
    //---------------------- 自定义变量区域 -----------------------------------
